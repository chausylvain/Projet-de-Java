...
public class AdditionExpression<E extends Number> extends BinaryExpression<E>
{
	...
	protected E operate(E value1, E value2) throws UnsupportedOperationException
	{
		...
		{
			// TODO 500 replace with correct implementation
			return (E) Integer.valueOf(0);
		}
		if (value1 instanceof Float)
		{
			// TODO 501 replace with correct implementation
			return (E) Float.valueOf(0);
		}
		if (value1 instanceof Double)
		{
			// TODO 502 replace with correct implementation
