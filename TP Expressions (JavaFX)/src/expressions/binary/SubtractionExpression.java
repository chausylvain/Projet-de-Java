 ...
 */
public class SubtractionExpression<E extends Number> extends BinaryExpression<E>
{
	/**
	 * Valued consrtructor
	 ...
	 */
	public SubtractionExpression(Expression<E> left,
	                             Expression<E> right)
	{
		super(left, right, BinaryOperatorRules.SUBTRACTION);
	}
	...
	{
		/*
		 * TODO Update to match subtraction operations
		 */
