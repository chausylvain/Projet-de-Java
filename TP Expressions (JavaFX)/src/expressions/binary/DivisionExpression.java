 ...
 */
public class DivisionExpression<E extends Number> extends BinaryExpression<E>
{
	/**
	 * Valued consrtructor
	 ...
	 */
	public DivisionExpression(Expression<E> left,
	                          Expression<E> right)
	{
		super(left, right, BinaryOperatorRules.DIVISION);
	}
	...
	{
		/*
		 * TODO update to match division operations
		 */
